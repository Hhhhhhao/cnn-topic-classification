...
class Trainer(object):
    ...
    def build_model(self):
        self.model = TopicClassCNN(
            ...
            pooling_index=self.config.pooling_index,
        ...
        # checkpoint = '/home/haochen/Projects/cnn-topic-classification/pretrained_bert/uncased_L-12_H-768_A-12/bert_model.pth'
    ...
    def valid_epoch(self, epoch):
        ...
        val_acc5 = []
        with torch.no_grad():
            for batch_idx, (sentences, gt_topics) in enumerate(self.valid_loader):
