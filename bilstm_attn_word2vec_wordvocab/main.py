...
def main(config):
    ...
    logger.info("loading best checkpoint from {}".format(config.checkpoint_dir))
    ...
    acc, confusion_matrix = eval_validation_set(
        filename, vocab.w2i, vocab.t2i, model, device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp-name', type=str, default="lstm_non_static", help='exp name')
    # learning
    parser.add_argument('--lr', type=float, default=0.0002, help='initial learning rate [default: 0.001]')
    parser.add_argument('--weight_decay', type=float, default=0.1, help='weight decay [default: 0.0001]')
    ...
    parser.add_argument('--lstm-hidden', type=int, default=256,help='lstm hidden size [default: 512]')
