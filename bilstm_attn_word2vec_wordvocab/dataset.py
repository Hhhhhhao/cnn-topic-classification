...
class Vocabulary:
    ...
    def __init__(self):
        ...
        if not os.path.exists(os.path.join(main_dir, 'data/plain_w2i.pkl')) or not os.path.exists(os.path.join(main_dir, 'data/t2i.pkl')):
            # generate w2i, t2i, and train data
            self.get_vocab()
        else:
            # read w2i, t2i from existing files and generate train_data
            with open(os.path.join(main_dir, 'data/plain_w2i.pkl'), "rb") as f:
    ...
    def get_vocab(self):
        ...
        with open(os.path.join(main_dir, 'data/plain_w2i.pkl'), "wb") as f:
...
if __name__ == '__main__':
    ...
    weight_matrix_1 = vocab.get_word2vec_weight(model_name='glove.6B', emb_size=300)
