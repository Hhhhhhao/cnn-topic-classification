...
def process_config(yaml_file):
    ...
    config.exp_name = config.exp_name + '_' + timestamp
    ...
    create_dirs([config.summary_dir, config.checkpoint_dir, config.log_dir, config.result_dir])
